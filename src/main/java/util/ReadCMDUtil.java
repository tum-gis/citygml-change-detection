...
public class ReadCMDUtil {
    ...
    public static boolean readCommandLindArguments(String[] args) throws IOException {
        for (String arg : args) {
    ...
    public static boolean readCommandLindArguments(String configFile) throws IOException {
        parseCommandLineArguments(configFile);

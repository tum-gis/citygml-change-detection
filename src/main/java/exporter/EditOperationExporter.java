...
public class EditOperationExporter {
	...
	public String exportEditOperationsToCSV(GraphDatabaseService graphDb, Node matcherRootNode, String exportFolder) {
		...
		try {
			// create files
			File fEditOperations = new File(filename + ".csv");
			File fUpdatePropertyOperations = new File(filename + "_UpdateProperty.csv");
			File fDeletePropertyOperations = new File(filename + "_DeleteProperty.csv");
			File fInsertPropertyOperations = new File(filename + "_InsertProperty.csv");
			File fDeleteNodeOperations = new File(filename + "_DeleteNode.csv");
			File fInsertNodeOperations = new File(filename + "_InsertNode.csv");
